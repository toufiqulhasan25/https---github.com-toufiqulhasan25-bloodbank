        ...
        <div class="col-md-12">
            <div class="card card-ghost border-0 p-4 bg-danger text-white shadow">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="fw-bold">You've saved up to {{ $history->where('status', 'approved')->count() * 3 }} lives!</h4>
                        <p class="mb-0 opacity-75">Every donation can save up to 3 lives. Thank you for being a hero, {{ Auth::user()->name }}.</p>
                    </div>
                    <div class="col-md-4 text-md-end mt-3 mt-md-0">
                        <div class="display-4 fw-bold">{{ str_pad($history->where('status', 'approved')->count(), 2, '0', STR_PAD_LEFT) }}</div>
...
<style>
    .card-ghost { border-radius: 15px; overflow: hidden; }
    ...
    .bg-warning-subtle { background-color: #fffde7; color: #f9a825; }
    .bg-secondary-subtle { background-color: #f5f5f5; color: #757575; }
</style>
@endsection